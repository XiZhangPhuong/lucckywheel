        ...
        return Scaffold(
          backgroundColor: ColorResources.BACKGROUND,
           appBar: controller.isLoading==false ? null : AppBar(
            ...
            leading: Image.network('https://www.blogger.com/img/logo_blogger_40px.png'),
            title: Text('Danh sách bài đăng Blogger',style: GoogleFonts.nunito(
              color: Colors.white,
              fontSize: 18,
            ),),
           ),
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  ...
                  child: ListTile(
                    ...
                    leading: Image.network('https://www.blogger.com/img/logo_blogger_40px.png'),
                    title: Text(
                      Validate.nullOrEmpty(item['title']) ? '' : item['title'].toString(),
                    ...
                    subtitle: Text(
                      Validate.nullOrEmpty(item['author']['displayName']) ? '' : 'Tác giả : ' + item['author']['displayName'].toString(),
                      style: GoogleFonts.nunito(
                        fontSize: 14,
                        color: Colors.white,
                      ),
